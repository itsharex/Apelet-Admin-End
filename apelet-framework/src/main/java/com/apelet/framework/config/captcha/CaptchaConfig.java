package com.apelet.framework.config.captcha;
...
public class CaptchaConfig {
    ...
    public DefaultKaptcha getKaptchaBeanMath() {
        ...
        properties.setProperty(KAPTCHA_TEXTPRODUCER_IMPL,  "com.apelet.framework.config.captcha.CaptchaMathTextCreator");
        // 验证码文本字符间距 默认为2
