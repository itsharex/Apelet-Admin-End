...
public class ApeletConfig {
    ...
    public void setFileBaseDir(String fileBaseDir) {
        ApeletConfig.fileBaseDir = fileBaseDir  + File.separator + Constants.RESOURCE_PREFIX;
    }
    ...
    public void setApiPrefix(String apiDocsPathPrefix) {
        ApeletConfig.apiPrefix = apiDocsPathPrefix;
    }
    ...
    public void setAddressEnabled(boolean addressEnabled) {
        ApeletConfig.addressEnabled = addressEnabled;
    }
    ...
    public void setCaptchaType(String captchaType) {
        ApeletConfig.captchaType = captchaType;
    }
    ...
    public void setRsaPrivateKey(String rsaPrivateKey) {
        ApeletConfig.rsaPrivateKey = rsaPrivateKey;
    }
    ...
    public void setDemoEnabled(boolean demoEnabled) {
        ApeletConfig.demoEnabled = demoEnabled;
    }
